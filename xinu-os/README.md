...
*Windows Users*:
Try to install and enable WSL2 on your machine using [this guide](https://docs.microsoft.com/en-us/windows/wsl/install-win10).
Then install Ubuntu from [Microsoft Store](https://www.microsoft.com/en-us/p/ubuntu/9nblggh4msv6?activetab=pivot:overviewtab). 
...
You may now install [docker desktop](https://hub.docker.com/editions/community/docker-ce-desktop-windows).
Then use item 7 of [this guide](https://docs.docker.com/docker-for-windows/wsl/#:~:text=When%20Docker%20Desktop%20restarts%2C%20go,wsl%20%2D%2Dset%2Ddefault%20ubuntu%20.) to enable WSL2 integration in docker deskop. 
...
First, [upload the public key to GitHub](https://github.iu.edu/settings/ssh/new):
